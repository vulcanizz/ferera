		...
		<div class="incontent">
			<div class="img-content">
				...
				<div class="img-selected">
					<div class="wrapperc">
						<div class="group">      
						    <input id="inputstyle1" type="text" name="fname" value="fname" required>
						    <span class="highlight"></span>
						    <span class="bar"></span>
						    <label class="labels1">FIRSTNAME</label>
					    </div>
					    <div class="group">      
						    <input id="inputstyle1" type="text" name="lname" value="lname" style="margin-left: 30px;" required>
						    <span class="highlight"></span>
					...
					<div class="wrapperc">
						<div class="group">      
						    <input id="inputstyle1" type="text" name="postcode" value="postcode" required>
						    <span class="highlight"></span>
						    <span class="bar"></span>
						    <label class="labels1">POSTCODE</label>
					    </div>
					    <div class="group">      
						    <input id="inputstyle1" type="text" name="phone" value="phone" style="margin-left: 30px;" required>
						    <span class="highlight"></span>
						    <span class="bar3"></span>
					...
					<div class="wrapperc">
						<div class="group" style="margin-top:77px;">      
						    <textarea id="inputstyle1" style="width:580px;" type="text" name="postcode" rows="2" value="address" required></textarea>
						    <span class="highlight"></span>
			...
			<div class="add-content">
				<div class="payment">
					...
					<div class="price2"><input class="btnprice" type="submit" name="buy" value="NEXT"></div>
					<div class="price3">
