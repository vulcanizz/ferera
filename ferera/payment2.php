...
<div class="wrappera">
	...
	<form name="form1" action="payment2_api.php" method="POST">
	<div class="content">
		<div class="sider">
			<div class="block">
				<div class="b-1"></div>
		...
		<div class="incontent">
			<div class="img-content">
				...
				<div class="h2content">
					<div class="blk4"></div>
					<p class="h2" style="font-size:14px;">INSERT YOUR CARD FOR PAY</p>
				</div>
				<div class="img-selected">
					<div class="wrapperc">
						<div class="group">      
						    <input id="inputstyle1" type="text" name="nameholder" required>
						    <span class="highlight"></span>
						    <span class="bar"></span>
						    <label class="labels1">NAMEHOLDER</label>
					    </div>
					    <div class="group">      
						    <input id="inputstyle1" type="text" name="email" style="margin-left: 30px;" required>
						    <span class="highlight"></span>
						    <span class="bar3"></span>
						    <label class="labels1" style="margin-left: 30px;">EMAIL</label>
					    </div>
					</div>
					<div class="wrapperc">
						<div class="group">      
						    <input id="inputstyle1" type="text" name="ccv" required>
						    <span class="highlight"></span>
						    <span class="bar"></span>
						    <label class="labels1">CCV</label>
					    </div>
					    <div class="group">      
						    <input id="inputstyle1" type="text" name="expiry" style="margin-left: 30px;" required>
						    <span class="highlight"></span>
						    <span class="bar3"></span>
						    <label class="labels1" style="margin-left: 30px;">EXPIRY DATE</label>
					    </div>
					</div>
					<div class="wrapperc">
						<div class="group">      
						    <input id="inputstyle1" style="width:580px;" type="text" name="cardnumber" rows="2" required>
						    <span class="highlight"></span>
						    <span class="bar2"></span>
						    <label class="labels1">CARDNUMBER</label>
					    </div>
					</div>
					<img class="stepstyle" src="img/paymentstep2.png" alt="step1" style="width:500px;height:82px;">
				</div>
			</div>
			<?php
				include"conn.php";
			...
			<div class="add-content">
				<div class="payment">
					...
					<div class="price2">
						...
						<input class="btnprice" type="submit" name="buy" value="PAY">
					</div>
					<div class="price3">
