...
<?php
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            ...
            echo "<tr>";?>
                <td><img src="<?php echo $row["pim_img"];?>" alt="" height="100"></td>
                <td><p><?php echo $row["product_id"];?></p></td>
                <td><p><?php echo $row["pim_id"];?></p></td>
...
<hr>
<form action="uploadimg2_api.php" method="POST" enctype="multipart/form-data">
    <div class="footer">
    <table>
        <tr>
